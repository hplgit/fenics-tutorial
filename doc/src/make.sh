...
system doconce format html $name --encoding=utf-8 --html_style=bootswatch_journal "--html_body_style=font-size:20px;line-height:1.5" --html_code_style=inherit EXV=$EXV
